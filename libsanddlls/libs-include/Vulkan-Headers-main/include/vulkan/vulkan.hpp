...
public:
  ...
  void vkCmdSetRenderingAttachmentLocationsKHR(
      ...
      VULKAN_HPP_NOEXCEPT {
    return ::vkCmdSetRenderingAttachmentLocationsKHR(commandBuffer,
                                                     pLocationInfo);
  }

  void vkCmdSetRenderingInputAttachmentIndicesKHR(
      VkCommandBuffer commandBuffer,
      const VkRenderingInputAttachmentIndexInfoKHR *pLocationInfo) const
      VULKAN_HPP_NOEXCEPT {
    return ::vkCmdSetRenderingInputAttachmentIndicesKHR(commandBuffer,
                                                        pLocationInfo);
  }
...
template <typename Type, Type value = 0> struct CppType {};
} // namespace VULKAN_HPP_NAMESPACE
...
//=== VK_EXT_line_rasterization ===
VULKAN_HPP_DEPRECATED("The VK_EXT_line_rasterization extension has been "
...
VULKAN_HPP_DEPRECATED("The VK_EXT_index_type_uint8 extension has been promoted "
                      "to VK_KHR_index_type_uint8.")
...
VULKAN_HPP_DEPRECATED("The VK_EXT_load_store_op_none extension has been "
...
//=== VK_KHR_dynamic_rendering_local_read ===
template <>
struct StructExtends<PhysicalDeviceDynamicRenderingLocalReadFeaturesKHR,
                     PhysicalDeviceFeatures2> {
  enum { value = true };
};
...
template <>
struct StructExtends<RenderingAttachmentLocationInfoKHR,
                     GraphicsPipelineCreateInfo> {
  enum { value = true };
};
...
template <>
struct StructExtends<RenderingInputAttachmentIndexInfoKHR,
                     GraphicsPipelineCreateInfo> {
  enum { value = true };
};
...
//=== VK_KHR_shader_quad_control ===
template <>
struct StructExtends<PhysicalDeviceShaderQuadControlFeaturesKHR,
                     PhysicalDeviceFeatures2> {
  enum { value = true };
};
...
//=== VK_EXT_map_memory_placed ===
template <>
struct StructExtends<PhysicalDeviceMapMemoryPlacedFeaturesEXT,
                     PhysicalDeviceFeatures2> {
  enum { value = true };
};
...
template <>
struct StructExtends<PhysicalDeviceMapMemoryPlacedPropertiesEXT,
                     PhysicalDeviceProperties2> {
  enum { value = true };
};

template <> struct StructExtends<MemoryMapPlacedInfoEXT, MemoryMapInfoKHR> {
  enum { value = true };
};
...
//=== VK_KHR_shader_subgroup_rotate ===
template <>
struct StructExtends<PhysicalDeviceShaderSubgroupRotateFeaturesKHR,
                     PhysicalDeviceFeatures2> {
  enum { value = true };
};
...
template <>
struct StructExtends<ComputePipelineIndirectBufferInfoNV,
                     ComputePipelineCreateInfo> {
  enum { value = true };
};
...
//=== VK_KHR_shader_maximal_reconvergence ===
template <>
struct StructExtends<PhysicalDeviceShaderMaximalReconvergenceFeaturesKHR,
                     PhysicalDeviceFeatures2> {
  enum { value = true };
};
...
//=== VK_KHR_shader_float_controls2 ===
template <>
struct StructExtends<PhysicalDeviceShaderFloatControls2FeaturesKHR,
                     PhysicalDeviceFeatures2> {
  enum { value = true };
};
...
//=== VK_KHR_index_type_uint8 ===
template <>
struct StructExtends<PhysicalDeviceIndexTypeUint8FeaturesKHR,
                     PhysicalDeviceFeatures2> {
  enum { value = true };
};
...
//=== VK_KHR_line_rasterization ===
template <>
struct StructExtends<PhysicalDeviceLineRasterizationFeaturesKHR,
                     PhysicalDeviceFeatures2> {
  enum { value = true };
};
...
template <>
struct StructExtends<PhysicalDeviceLineRasterizationPropertiesKHR,
                     PhysicalDeviceProperties2> {
  enum { value = true };
};

template <>
struct StructExtends<PipelineRasterizationLineStateCreateInfoKHR,
                     PipelineRasterizationStateCreateInfo> {
  enum { value = true };
};
...
//=== VK_KHR_shader_expect_assume ===
template <>
struct StructExtends<PhysicalDeviceShaderExpectAssumeFeaturesKHR,
                     PhysicalDeviceFeatures2> {
  enum { value = true };
};
...
//=== VK_NV_raw_access_chains ===
template <>
struct StructExtends<PhysicalDeviceRawAccessChainsFeaturesNV,
                     PhysicalDeviceFeatures2> {
  enum { value = true };
};
...
//=== VK_NV_shader_atomic_float16_vector ===
template <>
struct StructExtends<PhysicalDeviceShaderAtomicFloat16VectorFeaturesNV,
                     PhysicalDeviceFeatures2> {
  enum { value = true };
};
...
//=== VK_NV_ray_tracing_validation ===
template <>
struct StructExtends<PhysicalDeviceRayTracingValidationFeaturesNV,
                     PhysicalDeviceFeatures2> {
  enum { value = true };
};
...
public:
  ...
  void init(VULKAN_HPP_NAMESPACE::Instance instanceCpp) VULKAN_HPP_NOEXCEPT {
    ...
    vkCmdSetRenderingAttachmentLocationsKHR =
        PFN_vkCmdSetRenderingAttachmentLocationsKHR(vkGetInstanceProcAddr(
            instance, "vkCmdSetRenderingAttachmentLocationsKHR"));
    vkCmdSetRenderingInputAttachmentIndicesKHR =
        PFN_vkCmdSetRenderingInputAttachmentIndicesKHR(vkGetInstanceProcAddr(
            instance, "vkCmdSetRenderingInputAttachmentIndicesKHR"));
    ...
    vkCmdSetLineStippleKHR = PFN_vkCmdSetLineStippleKHR(
        vkGetInstanceProcAddr(instance, "vkCmdSetLineStippleKHR"));
  ...
  void init(VULKAN_HPP_NAMESPACE::Device deviceCpp) VULKAN_HPP_NOEXCEPT {
    ...
    //=== VK_KHR_line_rasterization ===
    vkCmdSetLineStippleKHR = PFN_vkCmdSetLineStippleKHR(
        vkGetDeviceProcAddr(device, "vkCmdSetLineStippleKHR"));
