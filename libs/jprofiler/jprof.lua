...
local msgpack_old = package.loaded["libs/jprofiler/MessagePack"]
package.loaded["libs/jprofiler/MessagePack"] = nil
local msgpack = require(_prefix .. "libs/jprofiler/MessagePack")
package.loaded["libs/jprofiler/MessagePack"] = msgpack_old
