...
// ImFontAtlas::FontBuilderFlags You can set those flags on a per font basis in
...
// - prefer deep-copying this into your own ImFontBuilderIO instance if you use
...
// flags; return atlas->Build(); } // Prefer using '#define
