// Dear ImGui: standalone example application for Emscripten, using GLFW +
...
int main(int, char **) {
...
#endif
  {
    ...
    color_attachments.view =
        wgpuSwapChainGetCurrentTextureView(wgpu_swap_chain);
...
static bool InitWGPU() {
  ...
  wgpuDeviceSetUncapturedErrorCallback(wgpu_device, wgpu_error_callback,
                                       nullptr);
