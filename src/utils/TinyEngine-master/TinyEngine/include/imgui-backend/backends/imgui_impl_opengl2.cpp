...
//  as void*/ImTextureID. Read the FAQ about ImTextureID!
...
//  2021-12-08: OpenGL: Fixed mishandling of the ImDrawCmd::IdxOffset field!
//  This is an old bug but it never had an effect until some internal rendering
//  changes in 1.86. 2021-06-29: Reorganized backend to pull data from a single
//  structure to facilitate usage with multiple-contexts (all g_XXXX access
//  changed to bd->XXXX). 2021-05-19: OpenGL: Replaced direct access to
