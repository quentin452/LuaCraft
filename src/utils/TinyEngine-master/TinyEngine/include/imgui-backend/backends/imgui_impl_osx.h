...
//  to all key functions e.g. ImGui::IsKeyPressed(ImGuiKey_Space). [Legacy kVK_*
//  values will also be supported unless IMGUI_DISABLE_OBSOLETE_KEYIO is set]
//  [X] Platform: OSX clipboard is supported within core Dear ImGui (no specific
//  code in this backend). [X] Platform: Gamepad support. Enabled with
//  'io.ConfigFlags |= ImGuiConfigFlags_NavEnableGamepad'. [X] Platform: IME
//  support.
