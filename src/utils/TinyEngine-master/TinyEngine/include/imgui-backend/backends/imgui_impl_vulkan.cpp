...
//  2024-02-14: *BREAKING CHANGE*: Moved RenderPass parameter from
//  ImGui_ImplVulkan_Init() function to ImGui_ImplVulkan_InitInfo structure. Not
//  required when using dynamic rendering. 2024-02-12: *BREAKING CHANGE*:
//  Dynamic rendering now require filling PipelineRenderingCreateInfo structure.
//  2024-01-19: Vulkan: Fixed vkAcquireNextImageKHR() validation errors in
//  VulkanSDK 1.3.275 by allocating one extra semaphore than in-flight frames.
//  (#7236) 2024-01-11: Vulkan: Fixed vkMapMemory() calls unnecessarily using
//  full buffer size (#3957). Fixed MinAllocationSize handing (#7189).
//  2024-01-03: Vulkan: Added MinAllocationSize field in
//  ImGui_ImplVulkan_InitInfo to workaround zealous "best practice" validation
//  layer. (#7189, #4238) 2024-01-03: Vulkan: Stopped creating command pools
//  with VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT as we don't reset them.
//  2023-11-29: Vulkan: Fixed mismatching allocator passed to
