...
#include <src/libs/SFML-2.6.1/include/SFML/Graphics/RenderTarget.hpp>
...
public:
  ...
  ///
  /// \deprecated Use create(unsigned int, unsigned int, const ContextSettings&)
  /// instead.
  ///
  ////////////////////////////////////////////////////////////
  ...
  /// \param width    Width of the render-texture
  /// \param height   Height of the render-texture
  /// \param settings Additional settings for the underlying OpenGL texture and
  /// context
  ///
  /// \return True if creation has been successful
  ///
  ...
  ////////////////////////////////////////////////////////////
  /// \brief Tell if the render-texture will use sRGB encoding when drawing on
  /// it
  ///
