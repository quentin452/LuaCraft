...
private:
  ...
  mutable Transform m_inverseTransform; //!< Precomputed inverse projection
                                        //!< transform corresponding to the view
  mutable bool m_transformUpdated; //!< Internal state telling if the transform
                                   //!< needs to be updated
  mutable bool m_invTransformUpdated; //!< Internal state telling if the inverse
