...
#include <src/libs/SFML-2.6.1/include/SFML/Graphics/Shape.hpp>
#include <vector>
...
public:
  ...
  /// of the valid range.
  ///
  /// \param index Index of the point to change, in range [0 .. getPointCount()
  /// - 1] \param point New position of the point
  ///
  /// \see getPoint
  ///
  ////////////////////////////////////////////////////////////
