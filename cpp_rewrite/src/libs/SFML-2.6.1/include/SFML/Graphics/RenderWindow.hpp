...
#include <src/libs/SFML-2.6.1/include/SFML/Graphics/Image.hpp>
...
public:
  ...
  ///
  /// You can request sRGB encoding for a window by having the sRgbCapable flag
  /// set in the ContextSettings
  ///
...
private:
  ...
  ////////////////////////////////////////////////////////////
  unsigned int
      m_defaultFrameBuffer; //!< Framebuffer to bind when targeting this window
};
