...
#pragma clang diagnostic ignored "-Wshadow"
    ...
    enum Scancode {
      ...
      // Specification) For Non-US keyboards mapped to key 42 (Microsoft
      // Keyboard Scan Code Specification) Typical language mappings: Belg:£µ`
      // FrCa:<>} Dan:*' Dutch:`´ Fren:µ* Ger:'# Ital:§ù LatAm:[}` Nor:*@
      // Span:ç} Swed:*' Swiss:$£} UK:~# Brazil:}]
...
#pragma clang diagnostic pop
  ...
  ///
  /// \warning The result is OS-dependent: for example,
