...
#include <src/libs/SFML-2.6.1/include/SFML/Window/Vulkan.hpp>
...
public:
  ...
  ///
  /// \param mode  Video mode to use (defines the width, height and depth of the
  /// rendering area of the window) \param title Title of the window \param
  /// style %Window style, a bitwise OR combination of sf::Style enumerators
  ///
  ////////////////////////////////////////////////////////////
  WindowBase(VideoMode mode, const String &title,
