...
// Headers
////////////////////////////////////////////////////////////
#include <src/libs/SFML-2.6.1/include/SFML/Audio/Export.hpp>
#include <src/libs/SFML-2.6.1/include/SFML/Audio/InputSoundFile.hpp>
#include <src/libs/SFML-2.6.1/include/SFML/Audio/SoundStream.hpp>
#include <src/libs/SFML-2.6.1/include/SFML/System/Mutex.hpp>
#include <src/libs/SFML-2.6.1/include/SFML/System/Time.hpp>
#include <string>
#include <vector>
...
public:
  ...
  ////////////////////////////////////////////////////////////
  /// \brief Sets the beginning and duration of the sound's looping sequence
  /// using sf::Time
  ///
  /// setLoopPoints() allows for specifying the beginning offset and the
  /// duration of the loop such that, when the music is enabled for looping, it
  /// will seamlessly seek to the beginning whenever it encounters the end of
  /// the duration. Valid ranges for timePoints.offset and timePoints.length are
  /// [0, Dur) and (0, Dur-offset] respectively, where Dur is the value returned
  /// by getDuration(). Note that the EOF "loop point" from the end to the
  /// beginning of the stream is still honored, in case the caller seeks to a
  /// point after the end of the loop range. This function can be safely called
  /// at any point after a stream is opened, and will be applied to a playing
  /// sound without affecting the current playing offset.
  ///
  ...
  ///
  /// \param timePoints The definition of the loop. Can be any time points
  /// within the sound's length
  ///
  /// \see getLoopPoints
  ///
  ////////////////////////////////////////////////////////////
...
protected:
  ...
  /// the seek position for a loop. We then determine whether we are looping on
  /// a loop point or the end-of-file, perform the seek, and return the new
  /// position.
  ///
