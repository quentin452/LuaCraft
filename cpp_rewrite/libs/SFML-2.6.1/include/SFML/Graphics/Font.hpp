...
#include <src/libs/SFML-2.6.1/include/SFML/Graphics/Glyph.hpp>
#include <src/libs/SFML-2.6.1/include/SFML/Graphics/Rect.hpp>
#include <src/libs/SFML-2.6.1/include/SFML/Graphics/Texture.hpp>
#include <string>
#include <vector>
...
public:
  ...
  /// \param outlineThickness Thickness of outline (when != 0 the glyph will not
  /// be filled)
  ///
  ...
  ////////////////////////////////////////////////////////////
  /// \brief Determine if this font has a glyph representing the requested code
  /// point
  ///
...
private:
  ...
  ////////////////////////////////////////////////////////////
  /// \brief Find or create the glyphs page corresponding to the given character
  /// size
  ///
  /// \param characterSize Reference character size
  ///
  ...
  void *m_face; //!< Pointer to the internal font face (it is typeless to avoid
                //!< exposing implementation details)
  void *m_streamRec; //!< Pointer to the stream rec instance (it is typeless to
                     //!< avoid exposing implementation details)
  void *m_stroker; //!< Pointer to the stroker (it is typeless to avoid exposing
