...
#include <src/libs/SFML-2.6.1/include/SFML/Window/Export.hpp>
...
public:
  ...
  enum Type {
    ...
    SizeTopLeftBottomRight, //!< Double arrow cursor going from top-left to
                            //!< bottom-right
    SizeBottomLeftTopRight, //!< Double arrow cursor going from bottom-left to
                            //!< top-right
    SizeLeft,  //!< Left arrow cursor on Linux, same as SizeHorizontal on other
               //!< platforms
    SizeRight, //!< Right arrow cursor on Linux, same as SizeHorizontal on other
               //!< platforms
    SizeTop,   //!< Up arrow cursor on Linux, same as SizeVertical on other
               //!< platforms
    SizeBottom,  //!< Down arrow cursor on Linux, same as SizeVertical on other
                 //!< platforms
    SizeTopLeft, //!< Top-left arrow cursor on Linux, same as
                 //!< SizeTopLeftBottomRight on other platforms
    SizeBottomRight, //!< Bottom-right arrow cursor on Linux, same as
                     //!< SizeTopLeftBottomRight on other platforms
    SizeBottomLeft,  //!< Bottom-left arrow cursor on Linux, same as
                     //!< SizeBottomLeftTopRight on other platforms
    SizeTopRight,    //!< Top-right arrow cursor on Linux, same as
                     //!< SizeBottomLeftTopRight on other platforms
