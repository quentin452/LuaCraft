...
template <typename HandleType> class SharedHandleTraits;
...
struct HasDestructorType<HandleType, decltype((void)typename SharedHandleTraits<
                                              HandleType>::DestructorType())>
    : std::true_type {};
...
struct HasDestructor
    : std::integral_constant<bool, !std::is_same<DestructorTypeOf<HandleType>,
                                                 NoDestructor>::value> {};

//=====================================================================================================================

template <typename HandleType> class SharedHandle;

template <typename DestructorType, typename Deleter> struct SharedHeader {
  SharedHeader(SharedHandle<DestructorType> parent,
               Deleter deleter = Deleter()) VULKAN_HPP_NOEXCEPT
...
template <typename Deleter> struct SharedHeader<NoDestructor, Deleter> {
...
template <typename HeaderType> class ReferenceCounter {
public:
...
public:
  size_t addRef() VULKAN_HPP_NOEXCEPT {
    // Relaxed memory order is sufficient since this does not impose any
    // ordering on other operations
...
template <typename HandleType, typename HeaderType,
          typename ForwardType = SharedHandle<HandleType>>
...
public:
  ...
  SharedHandleBase(HandleType handle, Args &&...control_args)
      : m_control(new ReferenceCounter<HeaderType>(
            std::forward<Args>(control_args)...)),
        m_handle(handle) {}
  ...
  ~SharedHandleBase() {
    ...
    if (m_control && (m_control->release() == 1)) {
      ...
      // it is required to ensure that last thread is getting to destroy the
      // control block by ordering all atomic operations before this fence
...
protected:
  template <typename T = HandleType>
  static typename std::enable_if<!HasDestructor<T>::value, void>::type
  internalDestroy(const HeaderType &control,
                  HandleType handle) VULKAN_HPP_NOEXCEPT {
...
template <typename HandleType> class ObjectDestroyShared {
public:
  using DestructorType =
      typename SharedHandleTraits<HandleType>::DestructorType;

  template <class Dispatcher>
  using DestroyFunctionPointerType = typename std::conditional<
      HasDestructor<HandleType>::value,
      void (DestructorType::*)(HandleType, const AllocationCallbacks *,
                               const Dispatcher &) const,
      void (HandleType::*)(const AllocationCallbacks *, const Dispatcher &)
          const>::type;

  using SelectorType =
      typename std::conditional<HasDestructor<HandleType>::value,
                                DestructorType, HandleType>::type;
  ...
  ObjectDestroyShared(Optional<const AllocationCallbacks> allocationCallbacks
      ...
      : m_destroy(reinterpret_cast<decltype(m_destroy)>(
            static_cast<DestroyFunctionPointerType<Dispatcher>>(
                &SelectorType::destroy))),
        m_dispatch(&dispatch), m_allocationCallbacks(allocationCallbacks) {}

public:
  template <typename T = HandleType>
  typename std::enable_if<HasDestructor<T>::value, void>::type
  ...
  template <typename T = HandleType>
  typename std::enable_if<!HasDestructor<T>::value, void>::type
  destroy(HandleType handle) const VULKAN_HPP_NOEXCEPT {
    VULKAN_HPP_ASSERT(m_destroy && m_dispatch);
...
template <typename HandleType> class ObjectFreeShared {
public:
  using DestructorType =
      typename SharedHandleTraits<HandleType>::DestructorType;

  template <class Dispatcher>
  using DestroyFunctionPointerType = void (DestructorType::*)(
      HandleType, const AllocationCallbacks *, const Dispatcher &) const;
...
public:
  void destroy(DestructorType parent,
               HandleType handle) const VULKAN_HPP_NOEXCEPT {
    VULKAN_HPP_ASSERT(m_destroy && m_dispatch);
    (parent.*m_destroy)(handle, m_allocationCallbacks, *m_dispatch);
  }
...
template <typename HandleType> class ObjectReleaseShared {
public:
  using DestructorType =
      typename SharedHandleTraits<HandleType>::DestructorType;
  ...
  using DestroyFunctionPointerType =
      void (DestructorType::*)(HandleType, const Dispatcher &) const;
...
template <typename HandleType, typename PoolType> class PoolFreeShared {
public:
  using DestructorType =
      typename SharedHandleTraits<HandleType>::DestructorType;

  template <class Dispatcher>
  using ReturnType = decltype(std::declval<DestructorType>().free(
      PoolType(), 0u, nullptr, Dispatcher()));
  ...
  PoolFreeShared(SharedHandle<PoolType> pool,
      ...
      : m_destroy(reinterpret_cast<decltype(m_destroy)>(
            static_cast<DestroyFunctionPointerType<Dispatcher>>(
                &DestructorType::free))),
        m_dispatch(&dispatch), m_pool(std::move(pool)) {}
...
//=== VK_VERSION_1_0 ===
template <> class SharedHandleTraits<Instance> {
public:
...
template <> class SharedHandleTraits<Device> {
public:
  using DestructorType = NoDestructor;
...
template <> class SharedHandleTraits<DeviceMemory> {
public:
...
template <> class SharedHandleTraits<Fence> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<Semaphore> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<Event> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<QueryPool> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<Buffer> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<BufferView> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<Image> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<ImageView> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<ShaderModule> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<PipelineCache> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<Pipeline> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<PipelineLayout> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<Sampler> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<DescriptorPool> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<DescriptorSet> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<DescriptorSetLayout> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<Framebuffer> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<RenderPass> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<CommandPool> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<CommandBuffer> {
public:
  using DestructorType = Device;
...
//=== VK_VERSION_1_1 ===
template <> class SharedHandleTraits<SamplerYcbcrConversion> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<DescriptorUpdateTemplate> {
public:
  using DestructorType = Device;
...
using SharedDescriptorUpdateTemplateKHR =
    SharedHandle<DescriptorUpdateTemplate>;

//=== VK_VERSION_1_3 ===
template <> class SharedHandleTraits<PrivateDataSlot> {
public:
  using DestructorType = Device;
...
//=== VK_KHR_surface ===
template <> class SharedHandleTraits<SurfaceKHR> {
public:
...
//=== VK_KHR_swapchain ===
template <> class SharedHandleTraits<SwapchainKHR> {
public:
  using DestructorType = Device;
...
//=== VK_KHR_display ===
template <> class SharedHandleTraits<DisplayKHR> {
public:
...
//=== VK_EXT_debug_report ===
template <> class SharedHandleTraits<DebugReportCallbackEXT> {
public:
  using DestructorType = Instance;
...
//=== VK_KHR_video_queue ===
template <> class SharedHandleTraits<VideoSessionKHR> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<VideoSessionParametersKHR> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<CuModuleNVX> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<CuFunctionNVX> {
public:
  using DestructorType = Device;
...
//=== VK_EXT_debug_utils ===
template <> class SharedHandleTraits<DebugUtilsMessengerEXT> {
public:
  using DestructorType = Instance;
...
template <> class SharedHandleTraits<AccelerationStructureKHR> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<ValidationCacheEXT> {
public:
  using DestructorType = Device;
...
//=== VK_NV_ray_tracing ===
template <> class SharedHandleTraits<AccelerationStructureNV> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<PerformanceConfigurationINTEL> {
public:
  using DestructorType = Device;
  using deleter = ObjectDestroyShared<PerformanceConfigurationINTEL>;
};

using SharedPerformanceConfigurationINTEL =
    SharedHandle<PerformanceConfigurationINTEL>;

//=== VK_KHR_deferred_host_operations ===
template <> class SharedHandleTraits<DeferredOperationKHR> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<IndirectCommandsLayoutNV> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<CudaModuleNV> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<CudaFunctionNV> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<BufferCollectionFUCHSIA> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<MicromapEXT> {
public:
  using DestructorType = Device;
...
//=== VK_NV_optical_flow ===
template <> class SharedHandleTraits<OpticalFlowSessionNV> {
public:
  using DestructorType = Device;
...
template <> class SharedHandleTraits<ShaderEXT> {
public:
  using DestructorType = Device;
...
struct ImageHeader
    : SharedHeader<
          DestructorTypeOf<VULKAN_HPP_NAMESPACE::Image>,
          typename SharedHandleTraits<VULKAN_HPP_NAMESPACE::Image>::deleter> {
  ImageHeader(
      SharedHandle<DestructorTypeOf<VULKAN_HPP_NAMESPACE::Image>> parent,
      typename SharedHandleTraits<
          VULKAN_HPP_NAMESPACE::Image>::deleter deleter =
          typename SharedHandleTraits<VULKAN_HPP_NAMESPACE::Image>::deleter(),
...
template <>
class SharedHandle<VULKAN_HPP_NAMESPACE::Image>
    : public SharedHandleBase<VULKAN_HPP_NAMESPACE::Image, ImageHeader> {
...
public:
  ...
  explicit SharedHandle(
      VULKAN_HPP_NAMESPACE::Image handle,
      SharedHandle<DestructorTypeOf<VULKAN_HPP_NAMESPACE::Image>> parent,
...
protected:
  static void
  internalDestroy(const ImageHeader &control,
                  VULKAN_HPP_NAMESPACE::Image handle) VULKAN_HPP_NOEXCEPT {
...
struct SwapchainHeader {
  SwapchainHeader(
      ...
      typename SharedHandleTraits<VULKAN_HPP_NAMESPACE::SwapchainKHR>::deleter
          deleter = typename SharedHandleTraits<
              VULKAN_HPP_NAMESPACE::SwapchainKHR>::deleter())
      VULKAN_HPP_NOEXCEPT : surface(std::move(surface)),
                            parent(std::move(parent)),
                            deleter(std::move(deleter)) {}
...
template <>
class SharedHandle<VULKAN_HPP_NAMESPACE::SwapchainKHR>
    : public SharedHandleBase<VULKAN_HPP_NAMESPACE::SwapchainKHR,
                              SwapchainHeader> {
  using BaseType =
      SharedHandleBase<VULKAN_HPP_NAMESPACE::SwapchainKHR, SwapchainHeader>;
  using DeleterType =
      typename SharedHandleTraits<VULKAN_HPP_NAMESPACE::SwapchainKHR>::deleter;
  friend BaseType;
...
public:
  ...
  explicit SharedHandle(
      VULKAN_HPP_NAMESPACE::SwapchainKHR handle,
      SharedHandle<DestructorTypeOf<VULKAN_HPP_NAMESPACE::SwapchainKHR>> parent,
      SharedHandle<VULKAN_HPP_NAMESPACE::SurfaceKHR> surface,
      DeleterType deleter = DeleterType()) VULKAN_HPP_NOEXCEPT
      : BaseType(handle, std::move(surface), std::move(parent),
                 std::move(deleter)) {}

public:
  const SharedHandle<VULKAN_HPP_NAMESPACE::SurfaceKHR> &
  getSurface() const VULKAN_HPP_NOEXCEPT {
...
class SharedHandleBaseNoDestroy
    : public SharedHandleBase<HandleType, DestructorType> {
public:
...
protected:
  static void internalDestroy(const DestructorType &,
                              HandleType) VULKAN_HPP_NOEXCEPT {}
};
...
public:
  ...
  explicit SharedHandle(PhysicalDevice handle, SharedInstance parent) noexcept
      : SharedHandleBaseNoDestroy<PhysicalDevice, SharedInstance>(
            handle, std::move(parent)) {}
};

using SharedPhysicalDevice = SharedHandle<PhysicalDevice>;

template <>
class SharedHandle<Queue>
    : public SharedHandleBaseNoDestroy<Queue, SharedDevice> {
...
public:
  ...
  explicit SharedHandle(Queue handle, SharedDevice parent) noexcept
      : SharedHandleBaseNoDestroy<Queue, SharedDevice>(handle,
                                                       std::move(parent)) {}
};
...
public:
  ...
  explicit SharedHandle(DisplayModeKHR handle, SharedDisplayKHR parent) noexcept
      : SharedHandleBaseNoDestroy<DisplayModeKHR, SharedDisplayKHR>(
            handle, std::move(parent)) {}
};
