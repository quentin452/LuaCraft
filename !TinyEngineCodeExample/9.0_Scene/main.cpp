...
#include "../../TinyEngine/include/helpers/object.hpp"
...
int main(int argc, char *args[]) {
  ...
  Shader cubedepth(
      {"shader/cubedepth.vs", "shader/cubedepth.gs", "shader/cubedepth.fs"},
      {"in_Position"});
  ...
  frame->model =
      glm::rotate(frame->model, glm::radians(90.0f), glm::vec3(0, 1, 0));
